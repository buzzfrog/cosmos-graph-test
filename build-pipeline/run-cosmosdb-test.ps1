...
Remove-CosmosDbDatabase -Context $COSMOSDB_CONTEXT -Id $DATABASE -ErrorAction SilentlyContinue
New-CosmosDbDatabase -Context $COSMOSDB_CONTEXT -Id $DATABASE
New-CosmosDbCollection -Context $COSMOSDB_CONTEXT -Id $COLLECTION -PartitionKey "partitionId" -OfferThroughput 100000
