...
$CONNECTION_STRING = "Server=tcp:localhost,$PORT;Initial Catalog=$DATABASE;Persist Security Info=False;User ID=sa;Password=$PASSWORD;MultipleActiveResultSets=False;Connection Timeout=30;"
